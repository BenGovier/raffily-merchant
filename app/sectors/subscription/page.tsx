      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 lg:mt-16 lg:flex lg:items-center lg:justify-between">
          ...
          <div className="mt-8 lg:mt-0 lg:flex-shrink-0">
            <Link
              href="/auth/register"
              className="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-lg text-base font-medium text-[#1E0B36] bg-white hover:bg-gray-100 transition-colors border border-gray-300 text-gray-700"
            >
              See It in Action
            </Link>
          </div>
